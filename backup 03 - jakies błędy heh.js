...
function wynik(){
    ...
    for (var i = 1; i <= 3; i++) {
        for (var nr = 0; nr < ciag_liczb.length; nr++) { // nr to numer szufladki w stringu
            if( isNaN( ciag_liczb[ nr ] )){
                //console.log('jestem w isNan');
                liczby = znajdz_liczby_wokol(ciag_liczb, nr);
               // console.log(ciag_liczb[ nr ]+" ciag");
                switch( ciag_liczb[ nr ] ) {
                    ...
                    case '-':
                        if( i == 3 ){
                            zamienic = ciag_liczb.substr(liczby[2],liczby[3]);
                            l_wyn_dzial = parseInt(liczby[0]) - parseInt(liczby[1]);
                            ciag_liczb = ciag_liczb.replace( zamienic, l_wyn_dzial );
                            // console.log( ciag_liczb.replace( zamienic, l_wyn_dzial ) );
                             console.log( liczby +" liczby");
                             console.log( zamienic +" zamienic");
                             console.log( l_wyn_dzial+" l_wyn_dzial" );
                             console.log( liczby+" liczby" );
                            nr = 0;
                            console.log( ciag_liczb +" koniec ciag");
                        }
                        break;
                    case '*':
                        if( i == 2 ){
